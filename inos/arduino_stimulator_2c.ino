...
// Channel 2
float STD_DUTY_CYCLE_2;
long NEG_PW_2; // us
long POS_PW_2; // us
long INTERPHASE_DELAY_2; // us (offset de 30us)
long MAIN_PERIOD_2; // us
long INTERPULSE_DELAY_2; // us
long PWM_MODE_2; // 0: rectangular; 1: exponential; 2: sinusoidal
long PWM_RANGE_2;
long NEG_TIME_OFFSET_2; // us
long POS_TIME_OFFSET_2; // us
float EXP_2; // expoente
...
STD_DUTY_CYCLE = 0.5;
  NEG_PW_2 = 700; // us
  POS_PW_2 = 500; // us
  INTERPHASE_DELAY_2 = 0; // us (offset de 30us)
  MAIN_PERIOD_2 = 4000;
  INTERPULSE_DELAY_2 = MAIN_PERIOD_2 - NEG_TIME_OFFSET_2 - NEG_PW_2 - INTERPHASE_DELAY_2 - POS_PW_2; // us
  PWM_MODE_2 = 0; // 0: rectangular; 1: exponential; 2: sinusoidal
  PWM_RANGE_2 = 256;
  NEG_TIME_OFFSET_2 = 50; // us
  POS_TIME_OFFSET_2 = 50; // us
  EXP_2 = -.0025;
  ...
  pinMode(NEG_PIN_2, OUTPUT);
  pinMode(POS_PIN_2, OUTPUT);
...
void loop()
{
  ...
  if (curr_status == before_first_pulse)
  {
    if (PWM_MODE == 0)
    {
      ...
      analogWrite(PWM_PIN_2, (int)(STD_DUTY_CYCLE*PWM_RANGE));
    }
    else
    {
