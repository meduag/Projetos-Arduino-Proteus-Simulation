...
// device names
String Device_1_Name = "Luz Forte";
String Device_2_Name = "Luz do quarto";
String Device_3_Name = "Luz mesa";
String Device_4_Name = "Luz amarela";

// device_function names
String Dev_Func_1_Name = "Modo Antonio";
String Dev_Func_2_Name = "Modo Janta";
String Dev_Func_3_Name = "Todos os dispositivos";
...
// WiFi Credentials
const char* ssid = "Abuelita Borracha 2.4G";
const char* password = "vaitomarnocu123";
